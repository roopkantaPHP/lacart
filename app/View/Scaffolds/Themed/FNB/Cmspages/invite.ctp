...
'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); return false;")); ?>
			...
			<ul>
				<li>
					...
					<?php echo $this->Form->input('emailaddress',array('div'=>false,'label'=>false,'placeholder'=>'Add friend'."'".'s email addresses','class'=>'disc-field')); ?>
					<span class="char-info left-align">Separate email ids with commas</span>
				</li>
				<li>
					<lable>Invite by sms</lable>
					<?php echo $this->Form->input('phone',array('div'=>false,'label'=>false,'placeholder'=>'Add friend'."'".'s phone numbers','class'=>'disc-field','required'=>false)); ?>
