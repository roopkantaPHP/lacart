...
<div class="col-md-12 right-section-content no-brdr <?php echo $randomString?>"> 
	...
	<div class="col-md-12 no-pd">
		<span class="btn black-btn col-sm-3 fileinput-button doc-upload-button">
...
$(function () {
    ...
    $('#fileupload').fileupload({
    	...
    	$('.' + random_class + '').closest('.lectur_li_item').find('.doc-upload-button').show();
    }).on('fileuploadadd', function (e, data) {
    	$('.' + random_class + '').closest('.lectur_li_item').find('.doc-upload-button').hide();
    	...
    	$('.' + random_class + '').closest('.lectur_li_item').find('.doc-upload-button').hide();
    	$('.' + random_class + '').closest('.lectur_li_item').find('.add-content').hide();
    	data.formData = {CONTENT_ID:'<?php echo $content_id?>', TYPE:'<?php echo DOC_TYPE ?>',COURSE_ID:COURSE_ID, LECTURE_ID:$('#fileupload').closest('.lectur_li_item').attr('data-lecture')};
    	...
    	console.log(data.result['content_data']['Lecture']['info']);
