...
<div class="row">
		<div class="floatleft mtop10"><h1><?php echo h("Cuisines Manager"); ?></h1></div>
		<div class="floatright">
			<?php
				echo $this->Html->link(
					"<span>Add Cuisines</span>", array(
						'controller' => 'dishes', 'action' => 'add_cuisine',
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			?>
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><?php echo $row['Cuisine']['name'];?></td>
					<td align="left"><?php echo ($row['Cuisine']['is_active']) ? 'Active' : 'Inactive';?></td>			
					<td align="left"><?php echo $this->Html->link('Edit', array('controller' => 'dishes', 'action' => 'add_cuisine', $row['Cuisine']['id']))?></td>
					<td align="center"><input type="checkbox" name="ids[]" value="<?php print $row['Cuisine']['id']; ?>"></td>
				</tr>
			<?php
					$i++;
				}
