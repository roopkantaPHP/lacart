	...
	<?php echo $this->Form->create(); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>
				...
				<th width="10%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('type','Type') ?></th>
				<th width="10%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('unit','Unit') ?></th>
				<th width="10%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('price','Price') ?></th>
			...
			?>
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><?php echo $row['Portion']['type'];?></td>
					<td align="left"><?php echo $row['Portion']['unit'];?></td>
					<td align="left"><?php echo $row['Portion']['price'];?></td>			
					<td align="left"><?php echo $this->Html->link('Edit', array('controller' => 'dishes', 'action' => 'add_portion', $row['Portion']['id']))?></td>
					<td align="center"><input type="checkbox" name="ids[]" value="<?php print $row['Portion']['id']; ?>"></td>
				</tr>
			<?php
					$i++;
				}
