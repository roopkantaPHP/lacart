...
<div class="row">
	...
	<div class="floatright"><?php echo $this->Html->link('<span>Add Newsletter</span>', array('controller' => 'newsletters', 'action' => 'add','admin' => true), array('class' => 'black_btn', 'escape' => false)) ?></div>
</div>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			?>
				<tr class="<?=$bgClass?>">			
					...
					<td align="center">
						<?php echo $this->Html->link($this->Html->image('/admin_images/edit_icon.gif'), array('controller'=>'newsletters', 'action'=>'admin_edit', $row['id']), array('escape' => false)) ?></td>
