		 ...
		 ?>
			<table cellspacing="0" cellpadding="7" border="0" align="center">				
				...
				<tr>
					...
					<td><b><?php echo ($this->request->data['Order']['payment_type']==0)?"Balanced Payment":"Paypal"; ?></b></td>
				</tr>
				<tr>
					...
					<td><b>
						...
						{ 
							echo $this->Html->link('Click here','https://dashboard.balancedpayments.com/#/marketplaces/'.BALANCED_URL_KEY,array('target'=>'blank'));
						}
						else
						{
				...
				<tr>
					...
					<td><b><?php 
							if ( isset($this->request->data['OrderAddress']['address']) &&
												 !empty($this->request->data['OrderAddress']['address']) ) {
								echo $this->request->data['OrderAdress']['address'];
