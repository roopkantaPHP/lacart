...
rules:{
    ...
    <div class="row">
		<div class="floatleft mtop10"><h1>Edit CmsCity</h1></div>
		<div class="floatright"><?php echo $this->Html->link('<span>Back to Cms Cities</span>', array('controller' => 'CmsCitys', 'action' => 'index','admin' => true), array('class' => 'black_btn', 'escape' => false)) ?></div>
    </div>
		 ...
		 ?>
			<table cellspacing="0" cellpadding="7" border="0" align="center">				
				...
				<tr>
					...
					<td><?php echo $this->Form->file('CmsCity.image', array('div'=>false, 'label'=>false, 'class'=>'input', 'size'=>'115','required'=>false)); ?></td>
				</tr>
				<tr>
