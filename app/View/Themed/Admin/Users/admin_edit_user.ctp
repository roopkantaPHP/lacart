<div class="row">
	...
	<div class="floatright"><?php echo $this->Html->link('<span>Back to Users List</span>', array('controller' => 'users', 'action' => $redirect_action), array('class' => 'black_btn', 'escape' => false)) ?></div>
</div>
	...
	<?php echo $this->Form->hidden('group_id'); ?>
		<table cellspacing="0" cellpadding="7" border="0" align="center">
			...
			<tr>
				...
				<td><?php echo $this->Form->input('password', array('div'=>false, 'label'=>false, 'class'=>'input', 'size'=>'70', 'required' => false)); ?></td>
			</tr>
