	...
	echo $this->Form->hidden('user_id');
		...
		<table cellspacing="0" cellpadding="7" border="0" align="center">
			...
			<tr>
				...
				<td><?php echo $this->Form->input('User.allergy', array('options'=> $allergy,'multiple' =>true,'div'=>false, 'label'=>false, 'class'=>'input required')); ?></td>
			</tr>
			<tr>
				<td valign="middle"><strong class="upper">Diet:</strong></td>
				<td><?php echo $this->Form->input('User.diet', array('options'=> array('Vegetarian'=>'Vegetarian','Non-Vegetarian'=>'Non Vegetarian','Vegan'=>'Vegan'),'div'=>false, 'label'=>false, 'class'=>'input required')); ?></td>
			</tr>
			<tr>
				<td valign="middle"><strong class="upper">Cuisine:</strong></td>
				<td><?php echo $this->Form->input('Kitchen.cuisine', array('options'=> $cuisine,'div'=>false, 'label'=>false, 'class'=>'input required')); ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><?php echo $this->Form->input('Kitchen.status', array('options'=> array('On'=>'On','Off'=>'Off'),'div'=>false, 'label'=>false, 'class'=>'input required')); ?></td>
			</tr>
			<tr>
