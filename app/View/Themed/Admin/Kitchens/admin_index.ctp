	...
	<?php echo $this->Form->create(); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>
				...
				<th width="2%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('User.is_paypal_verified','Paypal Account') ?></th>		
				<th width="2%" align="left" nowrap="nowrap"><?php echo 'Stripe Connect'; ?></th>		
			...
			?>
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><b><?php echo ($row['User']['is_paypal_verified'] == 1)?"Yes":"No";?></b></td>
					<td align="left"><b><?php echo (!empty($row['User']['stripe_user_id']))?"Yes":"No";?></b></td>
