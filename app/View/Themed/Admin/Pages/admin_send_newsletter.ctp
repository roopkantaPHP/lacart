...
function submit_form(frmobj,comb)
{
	...
	if (document.getElementById('PageNewsletterId').value == "")
	{
...
<div class="row searchbox floatleft mtop30" style="background-color: white; padding: 10px;">
	<p><?php echo $this->Form->create('', array('type'=>'GET')); ?>
	...
	<?php echo $this->Form->create('', array('method'=>'post')); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>
				...
				<th width="20%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('User.email','Email') ?></th>				
				<th width="10%" align="right" nowrap="nowrap"><?php echo $this->Paginator->sort('User.created','Registration Date') ?></th>				
			...
			?>
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><?php echo $row['Subscriber']['email'];?></td>					
					<td align="left"><?php echo date('d/m/Y H:i a', strtotime($row['Subscriber']['created']));?></td>										
					<td align="center"><input type="checkbox" name="ids[]" value="<?php print $row['Subscriber']['email']; ?>"></td>
				</tr>
			<?php
					$i++;
				}
