<?php 	echo $this->Html->script('common');
		$statusType = array(0 => 'Not verified', 1 => 'Confirmed', 2 => 'Completed', 3 => 'Declined by Owner', 4 => 'Declined by buyer');
		$payType = array(0 => 'Stripe', 1 => 'Paypal');
 ?>
<script>
	...
	<?php echo $this->Form->create(); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>				
				...
				<th width="2%" align="left" nowrap="nowrap">No. of dishes</th>
				<th width="2%" align="left" nowrap="nowrap">Delivery fee</th>
				<th width="5%" align="left" nowrap="nowrap">Order Value</th>
				<th width="2%" align="left" nowrap="nowrap">Tax Percent</th>
				<th width="5%" align="left" nowrap="nowrap">Sales Tax</th>
				<th width="5%" align="left" nowrap="nowrap">Total Amount</th>
				<th width="8%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('Order.created','Created Date') ?></th>
				<th width="8%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('Order.delivery_date','Delivery Date') ?></th>
			...
			?>
				<tr class="<?=$bgClass?>">			
					...
					<td align="left"><?php echo "$".$row['Order']['service_fee'];?></td>
					<td align="left"><?php echo "$".$row['Order']['order_value'];?></td>
					<td align="left"><?php echo $row['Order']['tax_percent']."%";?></td>
					...
					<td align="left"><?php echo date('M d,Y',strtotime($row['Order']['delivery_date']));?></td>	
					<td align="left"><?php echo ($row['Order']['payment_type']==0)?"Stripe Payments":"Paypal"; ?></td>
					<td align="left"><?php 
						if($row['Order']['is_verified']==0)
							echo '<span style="font-weight:bold; color:gray">Not verified</span>';
						else if($row['Order']['is_verified']==1)
							echo '<span style="font-weight:bold; color:orange">Confirmed</span>';
						else if($row['Order']['is_verified']==2)
							echo '<span style="font-weight:bold; color:green">Completed</span>';
						else if($row['Order']['is_verified']==3)
							echo '<span style="font-weight:bold; color:brown">Declined by owner</span>';
						else if($row['Order']['is_verified']==4)
							echo '<span style="font-weight:bold; color:red">Declined by buyer</span>';		  ?></td>		
