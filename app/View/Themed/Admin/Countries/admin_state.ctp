...
<div class="row">
		<div class="floatleft mtop10"><h1><?php echo h("State Manager"); ?></h1></div>
		<div class="floatright">
			<?php
				echo $this->Html->link(
					"<span>Add State</span>", array(
						'controller' => 'countries', 'action' => 'add_state',
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center"><table width="90%" border="0" cellpadding="4" cellspacing="1" >
        <tr>
          <td colspan="4" align="left" class="header_bg">Advance State Search</td>
        </tr>        
        <tr class="oddRow">
          <td align="right"><strong>State Name</strong>:</td>
          <td align="left"><input name="name" type="text" class="input" id="name" ></td>
          <td align="right"><strong>Country Name</strong>:</td>
          <td align="left"><input name="country" type="text" class="input" id="Country" ></td>         
	...
	<?php echo $this->Form->create(); ?>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
			...
			<tr>
				...
				<th width="10%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('code','Code') ?></th>
				<th width="10%" align="left" nowrap="nowrap"><?php echo $this->Paginator->sort('Country.country','Country Name') ?></th>
			...
			?>
				<tr class="<?=$bgClass?>">
					...
					<td align="left"><?php echo $row['State']['name'];?></td>
					<td align="left"><?php echo $row['State']['code'];?></td>		
					<td align="left"><?php echo $row['Country']['country'];?></td>					
					<td align="left"><?php echo $this->Html->link('Edit', array('controller' => 'countries', 'action' => 'add_state', $row['State']['id']))?></td>
					<td align="center"><input type="checkbox" name="ids[]" value="<?php print $row['State']['id']; ?>"></td>
				</tr>
			<?php
					$i++;
				}
