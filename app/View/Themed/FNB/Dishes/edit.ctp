...
<?php echo $this->element('timeslider_server_dish');
...
{ 
    ...
    $time_selected1 = ($h1*60)+$m1+1110;
    $time_selected2 = ($h2*60)+$m2+1110;
    $serveTimeRange = $this->request->data['Dish']['serve_start_time']." - ".$this->request->data['Dish']['serve_end_time'];
    $time_span = $time_selected1.', '.$time_selected2;
}
?>
...
<?php
    ...
    $checkSmallPortion = false;
    $checkBigPortion = false;
    $checkCustomPortion = false;
            	...
            	<section class="portion-inner-div">
                    ...
                    <section class="price-info <?php echo $classSmallPortion; ?>" id="forSmall">
                        ...
                        <span class="Qty">Quantity <br/>
                            <?php echo $this->Form->input('Dish.p_small_quantity',array('class'=>'qty-field numeric','type' => 'number','min' => 1,'label'=>false,'div'=>false));
  ...
  'min' => 1,'label'=>false,'div'=>false));
                	...
                	<section class="price-info <?php echo $classCustomPortion; ?>"  id="forCustom">
                    	<span class="price">price <br/>
                            <?php echo $this->Form->input('Dish.p_custom_price',array('class'=>'qty-field numeric','type' => 'number','min' => 1,'label'=>false,'div'=>false)); ?>
                        </span>
                    	<span class="Qty">Quantity <br/>
                	   ...
                	   <div class="clearfix"></div>
                	   <b>The custom pricing will be approved by our management before it can become available. This typically takes 24 hours.</b>
                	</section>
            	</section>
        	</section>
        	...
        	<section class="Commmon-allergens clearfix">
        	   <h3 class="ingred-title-bar">Common allergens</h3><br/>
                ...
                <section class="bank-details clearfix">
                    ...
                    <section class="serving-time clearfix">
                        ...
                        <main class="dishes-status-info">
                            ...
                            <b id="limittime"></b>
                             <?php echo $this->Form->input('Dish.serve_time',array('type'=>'hidden','label'=>false,'value'=>$serveTimeRange)); ?>
                            <div class="clearfix"></div>
                            <span>
                                <div>
                    ...
                    <section class="loadtime clearfix">
                        ...
                        <main class="dishes-status-info">
                            ...
                            <b id="loadtime"></b>
                             <?php echo $this->Form->input('Dish.lead_time',array('type'=>'hidden','label'=>false,'value'=>1));?>
                            <div class="clearfix"></div>
                            <span>
                                <div>
...
<script>
	$(document).ready(function(){
        ...
        <?php if(isset($pageError) && $pageError==1)
        {
        ?>
