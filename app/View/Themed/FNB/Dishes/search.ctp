                ...
                if(!empty($this->params['named'])) { ?>
		 		...
		 		<?php }?>
		 			...
		 			<div class="filter-box sl-popup" id="filterpopup">
    					...
    					<?php echo $this->Form->hidden('',array('id'=>'search_key_url','value'=>$this->Common->getSearchUrl('t','S_SEARCHTIME/date:S_SEARCHDATE/cu:S_SEARCHCUISINE/diet:S_SEARCHDIET/dine:S_SEARCHDINE/o_popular:S_SORTPOPULAR/o_rating:S_SORTRATING/q:S_SEARCHKEY/loc:S_SEARCHLOC/lat:S_SEARCHLAT/lng:S_SEARCHLNG/'))); ///cry:S_SEARCHRG ?>
				    ...
				    <li class="pictureItem" rel="<?php echo $result['Kitchen']['id']?>">
						...
						<div class="result-lower">
                            ...
                            <?php if(count($result['Dish']) > 2){ ?>
                                <a href="javascript:void(0);" class="more-items showAllLi"><?php echo '+'.$moreCount.' more'; ?></a>  
                            <?php  }else{ ?>
                                <a href="<?php echo $this->Html->url(array('controller'=>'kitchens','action'=>'index',$result['Kitchen']['id'])); ?>" class="more-items"> view kitchen </a>  
                            <?php } ?>
