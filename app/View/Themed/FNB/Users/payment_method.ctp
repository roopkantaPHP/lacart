	    ...
	    <div class="container">
			<div class="tabs-bar clearfix">
				<ul>
				 ...
				 <li><?php echo $this->Html->link('Stripe','javascript:void(0);',array('data'=>'receipt-tab')); ?></li>  
				</ul>
			</div>
		</div>
				  		...
				  		<div class="discussion-container">
							<ul>
								...
								<li>
									...
									<?php echo $this->Form->text('User.paypal_lname', array('label'=>false,'div'=>false,'class'=>'disc-field','autocomplete'=>"off")); ?>
								</li>
								<br/>
								<li>
