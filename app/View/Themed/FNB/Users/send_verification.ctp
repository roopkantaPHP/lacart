	    ...
	    <?php  echo $this->Form->create('User'); ?>
			<main>
				...
				<li class="textbox marginleftAuto">
					...
					echo $this->Form->input('User.city_id',array('class'=>'disc-field', 'type'=>'text', 'style'=>'width:30%; margin-left:5%; margin-bottom:20px;','empty'=>'Select City','label'=>false,'div'=>false));
