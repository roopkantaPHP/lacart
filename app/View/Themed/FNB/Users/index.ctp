		...
		<ul class="dish-lst clearfix">
			<li>
			 ...
			 <div class="data">
			  <div class="image"><?php echo $this->Html->image('img1.png'); ?></div>
			   <p>List your kitchen now to start serving</p>
			   <p>
			...
			<li class="margin_left">
			 ...
			 <div class="data">
			   ...
			   <p>Looking for something that nobody is currently serving?</p>
			   <p>
			   	<?php echo $this->Html->link('Request a dish',array('controller'=>'requestdishes','action'=>'newrequest'),array('class'=>'btn makerequset')); ?>
			   </p>
			 </div>
			</li>
		</ul>
				    ...
				    <ul class="bxslider">
						...
						{ 
						  	...
						  	{ 
								...
								?>
								<li style="height:220px; width:330px; padding:10px 50px; <?php echo $styleCode; ?>  background-size:100%;" class="featured">
