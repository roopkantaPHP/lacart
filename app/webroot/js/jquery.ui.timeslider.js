(function($) {  
    $.widget("ui.timeslider", {
        getTime: function(value){   
            var time = null;
            var localTime = new Date(value * 60 * 1000);
            var ptTime = new Date();
            minutes = localTime.getMinutes(localTime.getMinutes() + ptTime.getTimezoneOffset() - 240),
            hours = localTime.getHours(localTime.getHours() + ptTime.getTimezoneOffset() - 240);
